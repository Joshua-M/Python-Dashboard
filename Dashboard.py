...
def set_background(png_file):
    image_path = f"./images/{png_file.name}"
...
# Upload the PNG file for the background
...
if fl is not None:
    ...
    os.chdir(r"C:\Users\Joshua.Mahada\OneDrive - Park Advertising\Documents\Python_Iterative_Dashboard")
    df = pd.read_excel(r"C:\Users\Joshua.Mahada\OneDrive - Park Advertising\Documents\Python_Iterative_Dashboard\Sample - Superstore.xls")
